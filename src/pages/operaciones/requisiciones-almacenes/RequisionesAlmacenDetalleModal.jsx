...
export default function RequisionesAlmacenDetalleModal({ req: initialReq, onClose, onAnular }) {
            ...
            <div className="bg-white w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden relative z-10 animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
                ...
                <div className="p-10 pt-6 bg-white border-t border-slate-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        {canAnular && (
                            <button
                                onClick={() => onAnular(req)}
                                className="flex items-center gap-2 px-8 py-4 bg-red-50 text-red-600 rounded-md text-[11px] font-black uppercase tracking-widest hover:bg-red-100 transition-all border border-red-100"
                            >
                                <Trash2 size={16} />
                                Anular Requisición
                            </button>
