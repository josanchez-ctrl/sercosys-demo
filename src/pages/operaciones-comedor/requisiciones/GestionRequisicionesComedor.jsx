...
import { getRequisicionesAlmacen } from '../../../services/requisicionService';
...
import RequisionesComedorDetalleModal from './RequisicionesComedorDetalleModal';
...
export default function GestionRequisicionesComedor() {
  ...
  return (
    <div className="p-4 sm:p-8 space-y-2 animate-in fade-in duration-500 bg-slate-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em] mt-3 flex items-center gap-2">
              ...
              Recepción de insumos en comedor
            </p>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 animate-in slide-in-from-bottom duration-700">
        {/* Selector Sucursal */}
        <div className="flex items-center gap-4 bg-white p-2 px-4 rounded-md border border-gray-100 shadow-sm transition-all hover:border-brand-200">
          <div className="flex items-center gap-2 pr-4 border-r border-gray-100">
        ...
        {/* Selector Comedor */}
        <div className={`flex items-center gap-4 bg-white p-2 px-4 rounded-md border border-gray-100 shadow-sm transition-all hover:border-brand-200 ${!sucursalSel ? 'opacity-50 pointer-events-none' : ''}`}>
          <div className="flex items-center gap-2 pr-4 border-r border-gray-100">
      ...
      {showDetailModal && selectedReq && (
        <RequisionesComedorDetalleModal
          req={selectedReq}
          onClose={() => {
