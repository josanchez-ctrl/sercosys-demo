...
export default function MarcaModal({ initialData = null, empresaActiva, perfil, onClose, onUpdate }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                if (isEdit) {
                    await updateMarca(initialData.id, payload, perfil?.id);
                } else {
                    await createMarca(payload, perfil?.id);
                }
                onUpdate();
                onClose();
            } catch (err) {
                ...
                if (err.code === '23505') {
                    msg = 'Ya existe una marca con ese nombre en la empresa. Por favor, use un nombre diferente.';
                }
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mt-0.5 italic">
                                {isEdit ? initialData.nombre : 'Marcas'}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                placeholder="EJ: MARY, MIMESA, PRIMOR..."
                            />
                        </div>
