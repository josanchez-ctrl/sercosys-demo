-- Propósito: Bloquear o desbloquear un lote de inventario en COMEDOR
-- Última modificación: 2026-05-14

CREATE OR REPLACE FUNCTION public.fn_bloquear_lote_comedor(p_id_inventario bigint, p_is_bloqueado boolean, p_motivo text, p_id_usuario bigint)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
    ...
    RETURN jsonb_build_object('success', true, 'message', 'Estado de bloqueo en comedor actualizado correctamente');
