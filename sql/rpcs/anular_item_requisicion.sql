-- Propósito: Anulación individual de ítem en requisición
-- Última modificación: 2026-05-04

CREATE OR REPLACE FUNCTION public.anular_item_requisicion(p_id_item bigint, p_motivo text, p_id_usuario bigint)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
