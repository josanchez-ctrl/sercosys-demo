-- Propósito: Categorías de productos (rubros)
-- Última modificación: 2026-05-04

CREATE TABLE public.almacen_categorias (
...
-- Seguridad RLS
ALTER TABLE public.almacen_categorias ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Permitir acceso total a usuarios autenticados" 
ON public.almacen_categorias 
FOR ALL 
TO authenticated 
USING (true) 
WITH CHECK (true);
